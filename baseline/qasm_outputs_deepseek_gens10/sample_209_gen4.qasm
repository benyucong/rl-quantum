...
// Inter-community edges with penalty terms
// Edge (0,4) - inter-community
cx q[0], q[4];
rz(-0.5236) q[4];
cx q[0], q[4];

// Edge (0,2) - already in same community (handled above)
// Edge (1,3) - inter-community
cx q[1], q[3];
rz(-0.5236) q[3];
cx q[1], q[3];

// Edge (3,4) - same community (handled above)
// Edge (3,5) - same community (handled above)
// Edge (4,5) - same community (handled above)
