...
// Layer 1: Source and sink connections
...
// Layer 2: Mixing and additional edge interactions
h q[0];
h q[1];
h q[2];
h q[3];
...
// Layer 3: Mixing and sink connections
h q[0];
h q[1];
h q[2];
h q[3];
...
// Final sink-target optimization
rz(1.2566) q[9];  // Enhanced sink weighting
