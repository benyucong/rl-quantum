...
// First QAOA layer - Cost Hamiltonian (min-cut constraints)
...
// Second QAOA layer - Cost Hamiltonian (repeated with same parameters)
// Edge (0,6)
cx q[0], q[6];
rz(1.5708) q[6];
cx q[0], q[6];
