...
rz(0.0) q[7];    // Node 7 phase (unconnected)

// Layer 1: Entangling operations for bipartite matching constraints
// Constraint: Each left node connects to at most one right node
cx q[0], q[3];
rz(-0.196) q[3];
cx q[0], q[3];
cx q[0], q[6];
