...
// Connecting qubits based on the edges of the graph
cx q[0], q[1]; // Edge 0 -> 1
cx q[0], q[2]; // Edge 0 -> 2
cx q[0], q[3]; // Edge 0 -> 3
cx q[1], q[2]; // Edge 1 -> 2
