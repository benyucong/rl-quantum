...
// Problem Hamiltonian terms (community structure optimization)
...
// Edge (2,6) - same community penalty
cx q[2], q[6];
rz(0.3927) q[6];
cx q[2], q[6];
...
// Edge (4,6) - same community penalty
cx q[4], q[6];
rz(0.3927) q[6];
cx q[4], q[6];

// Edge (5,6) - same community penalty
cx q[5], q[6];
rz(0.3927) q[6];
cx q[5], q[6];

// Edge (5,7) - same community penalty
cx q[5], q[7];
rz(0.3927) q[7];
cx q[5], q[7];

// Edge (6,7) - same community penalty
cx q[6], q[7];
rz(0.3927) q[7];
cx q[6], q[7];
