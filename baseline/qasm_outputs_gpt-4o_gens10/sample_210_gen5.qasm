...
rz(0.5) q[4]; // Adjust flow from source to node 4
rz(0.3) q[5]; // Adjust flow from source to node 5
rz(0.2) q[2]; // Adjust flow from node 2
rz(0.1) q[3]; // Adjust flow from node 3
rz(0.4) q[6]; // Adjust flow to sink
