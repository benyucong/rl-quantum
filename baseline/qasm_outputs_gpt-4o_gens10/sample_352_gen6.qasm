...
// Layer 2: Apply inverse controlled operations
cx q[4], q[0]; // Inverse of edge from 0 to 4
cx q[4], q[1]; // Inverse of edge from 1 to 4
cx q[3], q[2]; // Inverse of edge from 2 to 3
cx q[4], q[2]; // Inverse of edge from 2 to 4
cx q[5], q[2]; // Inverse of edge from 2 to 5
cx q[2], q[3]; // Inverse of edge from 3 to 2
cx q[5], q[4]; // Inverse of edge from 4 to 5
