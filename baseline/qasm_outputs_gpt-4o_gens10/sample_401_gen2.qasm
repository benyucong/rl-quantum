...
rx(1.5708) q[1]; // Intermediate node
rx(0.7854) q[2]; // Intermediate node
rx(0.5236) q[3]; // Sink node

// Layer 2: Entangling operations
cx q[0], q[3]; // Source to Sink
cx q[1], q[2]; // Intermediate connection
cx q[2], q[3]; // Flow to Sink

// Layer 3: Adjusting amplitudes based on capacities
rz(0.1) q[0];
rz(0.2) q[1];
rz(0.3) q[2];
rz(0.4) q[3];
