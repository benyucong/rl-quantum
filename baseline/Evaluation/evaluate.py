...
def main():
    ...
    parser.add_argument(
        "--input", type=str, required=True, help="Dataset to use for generation"
    )
    
    parser.add_argument(
        "--output", type=str, default="results.json", help="File to save results"
    )
    
    args = parser.parse_args()
    
    summary_data, raw_data = process_circuits(args.input)
    
    
    # print(json.dumps(summary_data, indent=2))
    
    # Combine summary and raw data
    final_results = {
